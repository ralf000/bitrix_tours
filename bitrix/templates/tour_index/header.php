			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8">
						...
						<div class="logo">
							<img src="img/tour_logo.png" width="100px;" alt="">
						</div>
						<div class="sign">
		...
		<div class="content">
			<div class="container staff">
				...
				<ul class="head-slider">
					<li><img src="slider-photo/unsplash_52d5c05422a47_1.JPG"></li>
					<li><img src="slider-photo/unsplash_52cb185a63c25_1.JPG"></li>
					<li><img src="slider-photo/unsplash_52d5bbef8a613_1.JPG"></li>
				</ul>
				<!-- /slider -->
				...
				<div class="row">
					<div class="col-md-9">
						...
						<h1 class="txt-title">
							<span>&laquo;</span>Путешествуйте с нами по всему миру!<span>&raquo;</span>
						</h1>
