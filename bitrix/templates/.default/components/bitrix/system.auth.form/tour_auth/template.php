...
<div class="user-box">
    ...
    <? if ($arResult["FORM_TYPE"] == "login"): ?>
        ...
        <div class="user-box">
            <a href="/auth" class="enter">Авторизация</a>
            <a href="/registration" class="enter">Регистрация</a>
        </div>
    ...
    elseif ($arResult["FORM_TYPE"] == "otp"):
        ...
        <form action="<?= $arResult["AUTH_URL"] ?>">
            <span class="user-name"><?= $arResult["USER_NAME"] ?></span>
            <!--[<? /*= $arResult["USER_LOGIN"] */
            ?>]<br/>-->
            <a class="enter" href="<?= $arResult["PROFILE_URL"] ?>"
               title="<?= GetMessage("AUTH_PROFILE") ?>"><?= GetMessage("AUTH_PROFILE") ?></a>
            <? foreach ($arResult["GET"] as $key => $value): ?>
                <input type="hidden" name="<?= $key ?>" value="<?= $value ?>"/>
            <? endforeach ?>
            <input type="hidden" name="logout" value="yes"/>
            <input class="enter" type="submit" name="logout_butt" value="<?= GetMessage("AUTH_LOGOUT_BUTTON") ?>"/>
        </form>
    <? endif ?>
</div>
